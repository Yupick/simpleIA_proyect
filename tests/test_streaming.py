...
class TestStreamingSSE:
    ...
    def auth_headers(self, client):
        ...
        client.post(
            "/auth/register",
            json={"username": "streamuser", "password": "streampass123"},
        )

        # Login
        response = client.post(
            "/auth/login", data={"username": "streamuser", "password": "streampass123"}
        )
    ...
    def test_streaming_enabled_returns_stream(self, client, auth_headers):
        ...
        with patch(
            "app.models.model_manager.generate_stream",
    ...
    def test_streaming_unauthorized(self, client):
        ...
        response = client.post("/predict/", json={"prompt": "Test", "stream": True})
    ...
    def test_streaming_empty_response(self, client, auth_headers):
        ...
        with patch(
            "app.models.model_manager.generate_stream", side_effect=mock_empty_stream
        ):
            response = client.post(
                "/predict/",
                json={"prompt": "Test", "stream": True},
