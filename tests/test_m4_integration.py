...
class TestM4MultiTenant:
    ...
    def test_user_isolation_products(self):
        ...
        p1_id = products.create_product(
            user_id=self.user1_id, name="Laptop User1", price=1000.0, stock=5
        )

        products.create_product(
            user_id=self.user1_id, name="Mouse User1", price=50.0, stock=10
        )

        # User2 crea productos
        p3_id = products.create_product(
            user_id=self.user2_id, name="Laptop User2", price=1500.0, stock=3
        )
        ...
        logger.info("✅ Test aislamiento de productos: PASSED")

    def test_user_isolation_tasks(self):
        """Verifica que cada usuario solo vea sus propias tareas."""
        # User1 crea tareas
        t1_id = personal.create_task(
            user_id=self.user1_id, title="Tarea User1", priority="high"
        )

        # User2 crea tareas
        t2_id = personal.create_task(
            user_id=self.user2_id, title="Tarea User2", priority="medium"
        )
        ...
        logger.info("✅ Test aislamiento de tareas: PASSED")
    ...
    def test_user_isolation_appointments(self):
        ...
        logger.info("✅ Test aislamiento de citas: PASSED")
    ...
    def test_user_isolation_conversations(self):
        ...
        logger.info("✅ Test aislamiento de conversaciones: PASSED")
...
class TestCommercialAssistant:
    ...
    def test_get_context(self):
        ...
        logger.info("✅ Test context del asistente comercial: PASSED")
    ...
    def test_search_products(self):
        ...
        logger.info("✅ Test búsqueda de productos: PASSED")
    ...
    def test_build_system_prompt(self):
        ...
        logger.info("✅ Test system prompt comercial: PASSED")
...
class TestPersonalAssistant:
    ...
    def _create_sample_data(self):
        ...
        personal.create_task(
            user_id=self.user_id, title="Revisar emails", priority="medium"
        )
    ...
    def test_get_context(self):
        ...
        logger.info("✅ Test context del asistente personal: PASSED")
    ...
    def test_get_pending_tasks_by_priority(self):
        ...
        logger.info("✅ Test tareas por prioridad: PASSED")
    ...
    def test_build_system_prompt(self):
        ...
        logger.info("✅ Test system prompt personal: PASSED")
...
class TestDatabaseOperations:
    ...
    def test_product_crud(self):
        ...
        product_id = products.create_product(
            user_id=self.user_id, name="Test Product", price=100.0, stock=5
        )
        ...
        logger.info("✅ Test CRUD productos: PASSED")
    ...
    def test_task_crud(self):
        ...
        success = personal.update_task(
            task_id=task_id, user_id=self.user_id, status="completed"
        )
        assert success is True
        ...
        logger.info("✅ Test CRUD tareas: PASSED")


if __name__ == "__main__":
    logger.info("%s", "=" * 60)
    logger.info("INICIANDO PRUEBAS DEL MÓDULO 4")
    logger.info("%s", "=" * 60)
    logger.info("")
