...
class TrainingJob:
    ...
    def __init__(self, job_id: str, model_name: str, config: Dict, data_lines: int):
        self.job_id = job_id
...
class TrainingJobManager:
    ...
    def create_job(self, model_name: str, config: Dict, data_lines: int) -> str:
        """
    ...
    def update_progress(
        self, job_id: str, epoch: int, loss: float, step: int, total_steps: int
    ):
    ...
    async def run_job_async(self, job_id: str, train_func: Callable, *args, **kwargs):
        """
    ...
    def start_job(
        self, job_id: str, train_func: Callable, *args, **kwargs
    ) -> asyncio.Task:
        """
